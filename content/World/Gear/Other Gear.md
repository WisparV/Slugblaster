...
Bad things can happen to a hoverboard. You could shoot it out near a bottomless pit, focus it in a fit of rage, or lose it to an aggressive Rescue officer. Cautious slugblasters might like to know they have a second way home. Covers compound-energy photospheres, spare Nth gears, splat-hatches, etc. **(Costs 1 lens.)**

##### HARDECKER® SLUDGE FLARES
...
A beam filter attaches to your raygun, allowing you to not only adjust the energy type, but also dramatically reskin the way it looks. Change the color, sculpt the texture, make it look like a stream of glitched-out neon birds, whatever. **(Costs 1 disc, 1 lens.)**

##### PANIC ENERGY® FUEL-LINE

A 42 oz plastic cup of energy that never ends! PANIC claims the quantum lens in the cup jacks straight into their experimental R\&D department, full of new flavors. But many suspect it actually syncs with the spill trough of the nearest PANIC soda fountain. **(Costs 1 lens.)**
...
##### ANTIFEEDANT BODYSPRAY

Wearomone™ was sold as rizz in a can, then quickly discontinued as it became clear that it didn’t attract humans, did attract predators, and makes your skin so toxic and revolting that anything that tries to taste you immediately vomits a large amount of random slime (pg. 22). Six doses. **(Costs 1 coil.)**

##### GRAYMARKET CLONING KIT

Smuggled from Operaeblum’s grow-labs, these kits can culture organic matter at a rate of 1 kg/hour. Just spit some DNA into the specimen well and let it cook. Kits are intended for one-time use. Be careful. **(Costs 1 coil.)**

##### MIPER® SMART PUTTY™

Officially, this trendy fidget just, like, changes colour to match your lockscreen. But an ad-plagued third-party app can make it harden, stick, unstick, superconduct, or even (after clearing a dozen or so warning screens) self-destruct like C-4 explosive. **(Costs 1 disc, 1 coil.)**

##### RECALLED WILKIE’S® SLIME GRENADE™

What was meant to be a line of novelty lemonades quickly became a public health scare. Pull the pin, ignore the chittering, and stand clear of the 20-foot splash zone. Sold in a four-pack of random flavors (Slime Table). **(Costs 1 coil.)**

##### DETHROTTLED MAGNETIC CHARGE CASE

It was designed to charge your phone by siphoning street lamps or whatever, but by pulling the limiter pin it can effectively disable robots, security systems, or the town’s power grid. Requires solid contact. Excess power must be vented to avoid thermal runaway. **(Costs 1 coil, 1 gem.)**

##### SCRAM CAT® GEAR GENIE™ (RED EDITION)

This scandalous plug-and-play cheat cartridge has let so many kids hack hardlocked products that Miper could be buying Scram Cat just to discontinue it. Plug a disc component into one end, plug any piece of tech into the other. Actions involving this tech get +1d6 until you roll doubles, frying the disc. **(Costs 1 coil, 1 gem.)**

##### SMARTSYNCED SLAP STICKER

These blank, location-tracking Hardecker shipping labels can be hacked to sync with your phone and update remotely to display new text, art, or even animated gifs at will. Sheet of 8 labels. **(Costs 1 lens.)**

##### WILKIE’S® BLIND BOX™

A mystery prize secured behind a long, dopamine-soaked unboxing experience. Rip, peel, and twist through two dozen layers of delight-engineered packaging. **(Costs any 1 component.)**
...
A personal item from home, saturated with astral whatevers, typically worn by immigrants to delay peelback. In heavy-use applications such as slugblasting, the anchor protects the user from a single peelback event, then breaks. **(Costs 1 gem.)**

##### ALT TOKEN

A talisman from an alt-universe version of yourself that lets you temporarily switch places once per week. They have a skill you don’t and take any slams back with them, but you return with 1d6-4 slams too, from whatever crazy thing you had to do for them. **(Costs 1 disc, 1 gem.)**

##### PARAVERSE SOLVENT

Two parts hardgate coolant, one part astral condensate, loved by hackers and graff writers everywhere. Spray inanimate objects and watch them dissolve into alternate versions. Brick turns to glass, guns turn into bananas, and alien soil turns into the lino in your kitchen, creating a brief peelback sanctuary. Five uses. **(Costs 1 coil.)**

##### SOLITON FRAGMENT

A feather, a bone, a crystal shard. Those who touch their forehead to a soliton fragment have a chance (1–3) of feeling amazing (clear 1 slam), a chance (4–5) of becoming immortal for one minute, and a chance (6) of having a Revelation (Revelations Table). **(Costs 3 gems.)**

---

##### DE-SLUGGING CRYSTALS

It's uhh… salt. Yup. Just regular, grocery store salt. (3 uses) **(Costs1 lens.)**

##### HYPERPHASIC PAINT

Roll to coat a surface in temporary phase-through paint. (2 uses) **(Costs 1 gem, 1 lens.)**

##### INVISIWHOOP CUSHION

A bog-standard whoopie cushion with an acoustic amplifier and a localized photo bypass chip that wraps light around it to make it completely invisible. **(Costs 1 disc.)**

##### THE JUICE

Chaos energy incarnate, The Juice can rapidly charge complex electronics like signature devices. Gain a super slam to refill your turbo. (1 use) **(Costs 2 gems.)**

##### KINECTIC ORB

This orb can absorb and store any one kinetic strike that hits it. Later, on verbal command, the orb can release its kinetic potential back into the world. **(Costs 1 disc, 1 gem.)**

##### POLYPHASIC COUPON BOOK

Aggregates sales, specials, deals, and offers from across near-alternate universes then passes those savings on to you! **(Costs 1 lens.)**

##### SKUUT HARDLIGHT EMERGENCY SKUUTER™

A hardlight scooter capable of carving quantum slush. Handles are the only physical part of it. Good as a backup board. **(Costs 1 lens.)**

##### SLIME VENT

A portable one way portal to a slime dimension (don't ask). Just open the valve to jet out something slimy. Roll on the Slime table in the Slime zine to determine its properties!  **(Costs 1 coil, 1 gem.)**

##### BACKSTAGE PASS

Utilize localized photonic technology to project whatever image you'd like on some cardstock and lanyard. Your ticket to anywhere. **(Costs 1 gem, 1 lens.)**

##### SLUG DETECTOR

Roll to pick up slug life signatures from nearby slugs as well as any unexpected, slug-related anomalies. **(Costs 1 gem.)**

---

##### GREENTHUMB FERTI-DUST

Sprinkle a little bit of this magic dust from those delightful grannies at Hitherbees onto a plant or tree and roll to watch it grow rapidly. Toss on some kick for some real Jack and the Beanstalk shiz. One use only. **(Costs 1 gem.)**

##### VOIDWEAR CHILLBOX

Q. What's even cooler than a cooler? A. The Voidware Chillbox™. Store your goods in a persevering sub-zero extra-dimensional pocket. Great for beach days and for transporting refrigerated goods. Fits a 6 pack or two. **(Costs 1 coil, 1 lens.)**

##### HOVER-SADDLEBAGS

An industrial storage quadcopter that's programmed to slowly follow its owner. Best used for carrying bulky, heavier, or unsafe items across hazardous terrain. Responds loosely to any simple verbal commands. **(Costs 1 coil, 1 disc.)**

##### PORTAL SHREDDER

When you really need to get out of dodge, but the zone isn’t as thin as you want it to be you can always deploy a Portal Shredder. On the plus side, it’ll bore through a quad, but on the downside it does in the most brutal way imaginable. Roll to open a portal to a random dimension; everyone who uses it takes a slam that can’t be Noped (atomically smashed, dimensionally shredded, shaken and stirred). One use only. **(Costs 1 lens, 1 gem.)**

##### MIPER© M-TAG

Ever wanted to keep track of things across dimensions? Well now you can, with the Miper brand M-Tag. Just slap one of these on your package, signature, keys, or escaping villain and then just geo-locate it later on approved Miper devices (pack of two). **(Costs 1 disc.)**

##### REPROGRAPHIC CHAMBER

From the fine folks at Reprographia, this slime-filled, float-tank sized vat has everything you need to print a new body and upload your memories every hour on the hour in the event of your untimely demise. One use only.  **(Costs 1 disc, 2 gems.)**

##### SADDLETUFF™ SATCHEL

The Saddletuff™ line of SaddleTek bags folds timespace to create an ultra-dense protective weave. Anything in the bag can take a licking and keep ticking. Mark 1 trouble to avoid slams to this lunchbox-sized bag or anything in it from anything short of a 1 kiloton explosion.  **(Costs 1 gem.)**

##### STICKY HAND

The Slugblaster-sized version of one of those tacky isoprene polymer hands that stretch and stick to things. Use it to take hard corners, bungee jump, or yoink things from your sister. **(Costs 1 coil, 1 gem.)**
